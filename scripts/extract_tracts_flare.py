...
def extract_tracts_flare(vcf=str, num_ancs=int, output_dir=None, output_vcf=None, compress_output=None):
    # TBD: Make sure the code is tested with all possible combinations of arguments (optional and otherwise)
    # TBD: If compressing VCF, shouldn't it be BGZF compression and not just GZ compression?

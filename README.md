...
Example usage: ```python UnkinkMSPfile-Flags-switchpoints.py --msp FILENAME_STEM```
...
Example usage: ```python UnkinkGenofile-Flags.py --switches SWITCHES_FILE --genofile INPUT_VCF```
...
Example usage: ```python ExtractTracts-Flags.py --msp UNKINKED_MSPFILE --vcf UNKINKED_VCF```
